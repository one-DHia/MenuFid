    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      ...
      <main className="flex-1 py-14 px-4 max-w-4xl mx-auto w-full">
        <div className="bg-white p-8 sm:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-6 text-slate-700 text-xs sm:text-sm leading-relaxed">
          <h1 className="text-2xl sm:text-4xl font-black text-slate-900 mb-2">{t('terms_title')}</h1>
          <p className="text-slate-500 text-xs">{t('terms_subtitle')}</p>
          ...
          <section className="space-y-2">
            ...
            <p>
              Les abonnements sont proposés sous forme de forfaits mensuels sans engagement (Basic à 5€/mois, Fidélité à 10€/mois, Premium à 20€/mois). Le paiement s&apos;effectue via Stripe Checkout.
            </p>
          </section>
          ...
          <section className="space-y-2">
            ...
            <p>
              Les données récoltées restent la propriété exclusive du commerçant. MenuFid s&apos;engage à ne revendre aucune donnée à des tiers et à assurer leur hébergement sécurisé.
            </p>
          </section>
